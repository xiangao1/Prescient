...
def register_after_simulation_callback(callback: Callable[[Options, Simulator, OperationsStats], None]) -> None:
    ''' Register a callback to be called after the simulation is over.
    '''
